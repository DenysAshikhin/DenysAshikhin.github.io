...
import infoIcon from '../assets/images/info_white.svg';
                                ...
                                {bestAssemblies.length > 0 && (
                                    <>
                                        {bestAssemblies.map((e, index) => {
                                            return <AssemblyLine data={e.data} assemblyID={e.assembly.ID} index={index + 1} purchaseTime={e.purchaseTime} cost={e.cost} />
                                        })}
